...
export function YTConsentInstallingReShade() {
  const [playing, setPlaying] = useState(false);
  const url = "https://www.youtube.com/watch?v=FHcyIVYj55I";
  const videoId = getVideoId(url);
...
export function YTConsentDXVK() {
  const [playing, setPlaying] = useState(false);
  const url = "https://www.youtube.com/watch?v=-GYe_JVffHE";
  const videoId = getVideoId(url);
...
export function YTConsentDepth() {
  const [playing, setPlaying] = useState(false);
  const url = "https://www.youtube.com/watch?v=6xOSzYLeJB0";
  const videoId = getVideoId(url);
...
export function YTConsentLoadOrder() {
  const [playing, setPlaying] = useState(false);
  const url = "https://www.youtube.com/watch?v=WG378hzcplo";
  const videoId = getVideoId(url);
...
export function YTConsentFiveM() {
  const [playing, setPlaying] = useState(false);
  const url = "https://www.youtube.com/watch?v=JaT_Fjv7-2o";
  const videoId = getVideoId(url);
